            ...
            <ul className="nav navbar-nav pull-right">
              ...
              >
                ...
                >
                  ...
                  <span className="badge badge-default">12</span>
                </a>
            ...
            <ul className="nav navbar-nav">
              ...
              <li className="menu-dropdown classic-menu-dropdown">
                <a
                  ...
                  href="javascript:;"
                >
                  Öğrenci İşleri <i className="fa fa-angle-down" />
                </a>
                <ul className="dropdown-menu pull-left">
                  <li className="dropdown-submenu">
                    ...
                    <ul className="dropdown-menu">
                      <li className=" ">
                        <a href="/Form"> Öğrenci Yeni Kayıt </a>
                      </li>
                      <li className=" ">
                        <a href="/List"> Öğrenci Listesi </a>
                      </li>
                    </ul>
                  </li>
                  <li className="dropdown-submenu">
                    ...
                    <ul className="dropdown-menu">
                      <li className=" ">
                        <a href="/Form"> Sınıf Yeni Kayıt </a>
                      </li>
                      <li className=" ">
                        <a href="table_tree.html"> Sınıf Listesi </a>
                      </li>
                    </ul>
                  </li>
                </ul>
